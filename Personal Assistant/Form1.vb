Public Class Form1
    ...
    Private Sub LoginPanel_Paint(sender As Object, e As PaintEventArgs) Handles LoginPanel.Paint
        ControlPaint.DrawBorder(e.Graphics, e.ClipRectangle, Color.FromArgb(100, 32, 32, 32), 3, ButtonBorderStyle.Solid, Color.FromArgb(100, 32, 32, 32), 3, ButtonBorderStyle.Solid, Color.FromArgb(100, 32, 32, 32), 3, ButtonBorderStyle.Solid, Color.FromArgb(100, 32, 32, 32), 3, ButtonBorderStyle.Solid)
    End Sub
End Class
